...
import { GoogleFlightsAPI, SeatClass, Stops, Month, TimeFrame } from "../index.js";
import { GoogleFlightsConfig } from "../types/flights.js";

const testFlights = async () => {
    const [ locationDep ] = await GoogleLocationSearch('San Jose');
    const [ locationArr ] = await GoogleLocationSearch('Ho Chi Minh City');
